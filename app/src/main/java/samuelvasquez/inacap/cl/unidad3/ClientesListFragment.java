...
public class ClientesListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        clienteList = clienteDAO.getClientesByIdVendedor(id_vendedor);
        Log.d("onCreate", "clienteList ok");

        setListAdapter(new ArrayAdapter<Cliente>(
                activity,
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onClienteItemSelected(clienteList.get(position).id);
    }
